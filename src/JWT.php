...
class JWT
{
     ...
     * The HTTP parser.
     *
     * @var \Froiden\JWTAuth\Http\Parser\Parser
     */
    protected $parser;
     ...
     * The token.
     *
     * @var \Froiden\JWTAuth\Token|null
     */
    protected $token;
     ...
     *
     * @param  \Froiden\JWTAuth\Contracts\JWTSubject  $subject
     * @return string
     */
     ...
     *
     * @param  \Froiden\JWTAuth\Contracts\JWTSubject  $user
     * @return string
     */
     ...
     * @return \Froiden\JWTAuth\Payload|bool
     */
     ...
     * Get the token.
     *
     * @return \Froiden\JWTAuth\Token|null
     */
     ...
     * Set the token.
     *
     * @param  \Froiden\JWTAuth\Token|string  $token
     * @return $this
     */
     ...
     *
     * @return \Froiden\JWTAuth\Manager
     */
     ...
     *
     * @return \Froiden\JWTAuth\Http\Parser\Parser
     */

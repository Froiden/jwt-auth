...
class TokenValidatorTest extends AbstractTestCase
{
    ...
    /**
     * @test
     * @dataProvider \Froiden\JWTAuth\Test\Validators\TokenValidatorTest::dataProviderMalformedTokens
     *
     * @param  string  $token
     */
    ...
    /**
     * @test
     * @dataProvider \Froiden\JWTAuth\Test\Validators\TokenValidatorTest::dataProviderTokensWithWrongSegmentsNumber
     */

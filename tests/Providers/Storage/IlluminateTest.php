...
namespace Froiden\JWTAuth\Test\Providers\Storage;

use Illuminate\Contracts\Cache\Repository;
use Mockery;
use Froiden\JWTAuth\Providers\Storage\Illuminate as Storage;
use Froiden\JWTAuth\Test\AbstractTestCase;
use Froiden\JWTAuth\Test\Stubs\TaggedStorage;
...
class IlluminateTest extends AbstractTestCase
{
    ...
    /**
     * @var \Froiden\JWTAuth\Providers\Storage\Illuminate
     */
    protected $storage;
    ...
    private function emulateTags()
    {
        ...
        $this->cache->shouldReceive('tags')->with('froiden.jwt')->once()->andReturn(Mockery::self());
    }
